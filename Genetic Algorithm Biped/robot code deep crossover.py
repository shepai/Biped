...
epochs, pop_size, mutation_std = 150, 20, 0.02 #define data for training
#create out agent
...
for epoch in range(epochs):
    ...
    if g1_fit>g2_fit:
        co=crossover(gene_pop[n1], gene_pop[n2], p_crossover=0.5)
        gene_pop[n2]=copy.deepcopy(co) #copy over if fitter
    else:
        co=crossover(gene_pop[n2], gene_pop[n1], p_crossover=0.5)
        gene_pop[n1]=copy.deepcopy(co) #copy over if fitter
