...
class Agent:
    ...
    def set_genes(self, gene):
        ...
        bias_idxs = weight_idxs + weights2_idxs + weights3_idxs + self.num_output #sizes of biases
        ...
        w4 = gene[weights3_idxs: weights4_idxs].reshape(self.num_hidden2, self.num_hidden3) 
        b = gene[weights4_idxs: bias_idxs].reshape(self.num_hidden3,self.num_output) #merge genes
        ...
        self.weights4 = torch.from_numpy(w3) #assign weights
...
#create out agent
agent = Agent(num_obs, 5, 5, 5, num_actions)
